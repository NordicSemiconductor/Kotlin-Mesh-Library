...
import no.nordicsemi.kotlin.mesh.core.model.serialization.config.DeviceKeyConfig.EXCLUDE_KEY
import no.nordicsemi.kotlin.mesh.core.model.serialization.config.DeviceKeyConfig.INCLUDE_KEY
 ...
 * @property INCLUDE_KEY Use this constant to export nodes with their device keys.
 * @property EXCLUDE_KEY Use this constant to export nodes without their device keys.
 */
