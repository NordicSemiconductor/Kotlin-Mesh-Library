...
/**
 * This message is used to bind an Application Key to a model.
 *
...
class ConfigModelAppBind(
    ...
    /**
     * Convenience constructor to create a [ConfigModelAppBind] message.
     *
     * @param model           Model to bind the application key to.
    ...
    companion object Initializer : ConfigMessageInitializer {
        ...
        /**
         * Initializes the [ConfigModelAppBind] based on the given parameters.
         *
         * @param parameters Message parameters.
         * @return [ConfigModelAppBind] or null if the parameters are invalid.
         */
