...
dependencies {
    ...
    implementation("androidx.compose.material3:material3-adaptive-navigation-suite-android:1.4.0-alpha06")
    implementation("androidx.compose.material3.adaptive:adaptive:1.1.0-alpha09")
    implementation("androidx.compose.material3.adaptive:adaptive-layout-android:1.1.0-alpha09")
    implementation("androidx.compose.material3.adaptive:adaptive-navigation-android:1.1.0-alpha09")
}